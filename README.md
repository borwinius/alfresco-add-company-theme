...
#### Konfiguration:  
 - ersetze die Bilder:  
   ...
   `favicon.ico`  
mit den eigenen Bildern im Verzeichnis  `src/main/amp/web/themes/companyTheme/images/`  
 - sowie editiere die Dateien `src/main/amp/config/alfresco/web-extension/site-webscripts/de/borwinius/customization/footer/footer.get*.properties`mit dem eigenen Text.  
#### Ausführung:  
dann:  
...
- docker
- Alfresco 26.1
- Vorsicht bei Firefox, der Bildercache sollte bei extensiven Tests per F5 gelöscht werden.  
#### Screenshots  
